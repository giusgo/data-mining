...
export function Code({ command, output }: CodeProps) {
  return (
    <div className="my-5 w-full flex flex-col">
      <div className="text-sm p-1 flex items-center gap-2 text-gray-600 dark:text-white">
        <svg
          role="img"
          viewBox="0 0 24 24"
        ...
        >
          ...
          <path
            className="fill-current text-gray-600 dark:text-white"
